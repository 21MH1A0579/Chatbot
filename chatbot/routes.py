...
def get_response(return_list,intents_json,text):
    ...
    if tag=='weather':
        ...
        if response['cod']!=200:
            return "Please Enter Proper CityName \n OR \nType ':' before City name",'weather'
    ...
    if tag=='news':
        main_url = "https://newsapi.org/v2/top-headlines?country=us&apiKey=bc88c2e1ddd440d1be2cb0788d027ae2"
    ...
    if tag == 'cricket':
        return "Sorry I Can't Generate Cricket Score now",'cricket'
